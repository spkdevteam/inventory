...
const updateInvoiceItemKart = require("../../model/services/invoice/updateBillItemDetails");

const postUpdateBillItemDetailsOld = async (req, res, next) => {
    try {
        /* 
        ...
        */
        ...
        const result = await updateBillietmdetailsOld(data)
        console.log(result,'-------------->>>>>>>>>>>>>>>>>>>')
        if (result?.status) {
            const responce = {
...
module.exports = postUpdateBillItemDetailsOld;